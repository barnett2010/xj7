(function(e) {
    ...
    function a() {
        var t = i.parent(".ZoomPic").prev();
        if (t.length == 0) t = e(".ZoomPic a.imgclass:last-child");
        t.find("a").trigger("click")
    }
    function f() {
        var t = i.parent(".ZoomPic").next();
        if (t.length == 0) t = e(".ZoomPic a.imgclass:first-child");
    ...
    e("body").append('<div id="zoom"><a class="close"></a><div id="zoomIcons"><a href="#previous" class="previous"></a><a href="#next" class="next"></a></div><div class="content loading"></div></div>');
    var t = e("#zoom").hide(),
    n = e("#zoom .content"),
    r = false,
    i = null,
    ...
    o = e(window).height(); (function() {
        ...
        if (e(".ZoomPic a.imgclass").length == 1) e(".ZoomPic a.imgclass")[0].addClass("zoom");
        e(".zoom, .ZoomPic a.imgclass").on("click", u)
    })(); (function() {
